...
<html>
<head>
	<title>Relatório Contas à Pagar</title>
...
<body>	
	...
	<div class="titulo_cab titulo_img"><u>Relatório Contas à Pagar  <?php echo $tipo_rel ?> <?php echo $acao_rel ?> </u></div>	
	...
	<div class="mx-2" style="padding-top:10px ">
		...
		<?php 
		$query = $pdo->query("SELECT * from pagar where (data_venc >= '$dataInicial' and data_venc <= '$dataFinal') and pago LIKE '$pago' and referencia LIKE '$tipo' order by data_venc asc ");
...
//retirar quebra de texto do obs		
	...
	<div class="col-md-12 p-2">
		...
		<span class="text-danger"> <small><small><small><small>CONTAS PENDENTES</small> : R$ <?php echo $total_pendentesF ?></small></small></small>  </span>			

			<span class="text-success"> <small><small><small><small>CONTAS PAGAS</small> : R$ <?php echo $total_pagasF ?></small></small></small>  </span>
		</div>
	</div>
	<div class="cabecalho" style="border-bottom: solid 1px #0340a3">
	</div>
