...
<body>	
	...
	<div class="titulo_cab titulo_img"><u>Relatório de Vendas  <?php echo $tipo_rel ?> <?php echo $acao_rel ?> </u></div>	
	...
	<div class="mx-2" style="padding-top:10px ">
		...
		<?php 
		$query = $pdo->query("SELECT * from vendas where (data >= '$dataInicial' and data <= '$dataFinal') and pago LIKE '$pago' and corretor LIKE '$corretor' order by id desc ");
		$res = $query->fetchAll(PDO::FETCH_ASSOC);
		$total_reg = count($res);
		if($total_reg > 0){
			?>
			...
			<small><small>
				<section class="area-tab" style="background-color: #f5f5f5;">
					...
					<div class="linha-cab" style="padding-top: 5px;">
						...
						<div class="coluna" style="width:17%">CORRETOR</div>
						<div class="coluna" style="width:15%">COMPRADOR</div>
						<div class="coluna" style="width:15%">VENDEDOR</div>
						<div class="coluna" style="width:13%">R$ CORRETOR</div>
						<div class="coluna" style="width:13%">R$ IMOBILIÁRIA</div>
						<div class="coluna" style="width:12%">DATA PGTO</div>
		...
		$total_comissao_corF = number_format($total_comissao_cor, 2, ',', '.');
					...
					<section class="area-tab" style="padding-top:5px">					
						<div class="linha-cab">				
							...
							<div class="coluna" style="width:17%"><?php echo $nome_corretor ?></div>

							<div class="coluna" style="width:15%"><?php echo $nome_comprador ?></div>

							<div class="coluna" style="width:15%"><?php echo $nome_vendedor ?></div>
							...
							<div class="coluna" style="width:12%"><?php echo $data_pgtoF ?></div>								
