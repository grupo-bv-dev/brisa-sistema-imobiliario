...
//retirar aspas do texto do obs
		...
		<a href="#" onclick="alugar('{$id}', '{$titulo}', '{$comissao_imob_RS}', '{$comissao_corretor_RS}', '{$valor}', '{$valorF}')" title="Vender Imóvel"><i class="fa fa-money " style="color:green; margin-left:3px"></i></a>
