...
<small>
HTML;
$query = $pdo->query("SELECT * FROM $pagina where registro = 'Conta à Receber' and id_reg = '$id' order by id desc");
									...
									<ul class="dropdown-menu">
										<li>
											<div class="notification_desc2">
												<p>Confirmar Exclusão? <a href="#" onclick="excluirArquivoParcela('{$id}', '{$nome}')"><span class="text-danger">Sim</span></a></p>
...
<script type="text/javascript">
	...
	function excluirArquivoParcela(id, nome){
